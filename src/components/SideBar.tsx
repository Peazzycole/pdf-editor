...
import { FaTimes, FaHighlighter, FaSignature, FaFileAlt } from "react-icons/fa";
...
export default function SideBar({
    ...
    return (
        <div className="w-64 bg-white p-4 rounded-lg shadow-md border border-gray-200 space-y-4">
            ...
            {!file ? (
                ...
                <div className="space-y-2">
                    <button
                        ...
                        className={`flex items-center cursor-pointer space-x-2 w-full px-4 py-2 rounded-md transition-all duration-200 ${activeTool === "highlight" ? "bg-blue-600 text-white shadow-md" : "bg-gray-100 hover:bg-gray-200"
                            }`}
                    >
                        <FaHighlighter />
                        <span>Change Color</span>
                        {activeTool === "highlight" && (
                            <div className="w-4 h-4 rounded-full border border-white" style={{ backgroundColor: toolColor }} />
                        )}
                    </button>
                    <button
                        onClick={() => setActiveTool("signature")}
                        className={`flex items-center cursor-pointer space-x-2 w-full px-4 py-2 rounded-md transition-all duration-200 ${activeTool === "signature" ? "bg-blue-600 text-white shadow-md" : "bg-gray-100 hover:bg-gray-200"
                            }`}
                    >
                        <FaSignature />
